...
$(document).ready(function() {
        ...
        $(".button-order").click(function() {
        	$("html, body").animate({scrollTop: $("#hot-to-order-section").offset().top}, 1000);
        });
        ...
        // Select all links with hashes buttons and nav click
				$('a[href*="#"]')
				  ...
				  .click(function(event) {
				   ...
				   // animation
					...
					var waypoint = new Waypoint({
					  element: document.getElementById('hot-to-order-section'),
					  handler: function(direction) {
				...
				$(".mobila-nav-icon").click(function() {

                    var icon = $(".mobila-nav-icon i");
